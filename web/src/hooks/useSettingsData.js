...
function configFromServer(c = {}) {
  return {
    ...
    context_window_tokens: Number(c.context_window_tokens || 32768),
    output_reserve_tokens: Number(c.output_reserve_tokens || 4096),
    context_limits_estimated: c.context_limits_estimated !== false,
