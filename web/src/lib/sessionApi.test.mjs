...
import { createSessionRecord, fetchSessions, searchSessions } from './sessionApi.js';
...
test('session API adds project filters as query parameters', async () => {
  ...
  assert.equal(calls[2].path, '/api/sessions/search?q=hello&limit=30&project_id=project-2');
});
