...
func (s *Store) initSQLite() error {
	...
	stmts := []string{
		...
		`CREATE TABLE IF NOT EXISTS session_messages (workspace_id TEXT NOT NULL, session_id TEXT NOT NULL, message_index INTEGER NOT NULL, id TEXT NOT NULL, role TEXT NOT NULL, content TEXT NOT NULL, reasoning TEXT NOT NULL DEFAULT '', error_json TEXT NOT NULL DEFAULT '', attachments_json TEXT NOT NULL DEFAULT '[]', created_at TEXT NOT NULL, PRIMARY KEY(workspace_id, session_id, message_index), FOREIGN KEY(workspace_id, session_id) REFERENCES sessions(workspace_id, id) ON DELETE CASCADE)`,
