...
func (a *Server) handleListAgentTasks(w http.ResponseWriter, r *http.Request) {
	query := url.Values{}
...
func (a *Server) handleGetAgentTask(w http.ResponseWriter, r *http.Request) {
...
func (a *Server) handleDeleteAgentTask(w http.ResponseWriter, r *http.Request) {
	taskID := strings.TrimSpace(r.PathValue("id"))
	if taskID == "" {
		writeJSONResponse(w, http.StatusBadRequest, map[string]any{"code": "TASK_ID_REQUIRED", "error": "任务 ID 不能为空"})
		return
...
func (a *Server) handleGetSessionAgentTask(w http.ResponseWriter, r *http.Request) {
...
func (a *Server) latestSessionAgentTaskID(session *model.Session) (string, error) {
...
func (a *Server) proxyAgentDockTasks(w http.ResponseWriter, r *http.Request, runtimePath string, query url.Values) {
	a.proxyAgentDockTaskRequest(w, r, http.MethodGet, runtimePath, query, false)
}

func (a *Server) proxyAgentDockTaskRequest(w http.ResponseWriter, r *http.Request, method, runtimePath string, query url.Values, notFoundAsEmptyTask bool) {
