...
func (a *Server) handleGetSessionToolEventByID(w http.ResponseWriter, r *http.Request) {
...
func (a *Server) handleGetSessionToolEvent(w http.ResponseWriter, r *http.Request) {
	sessionID := r.PathValue("id")
