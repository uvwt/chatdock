...
func (a *Server) handleListProjects(w http.ResponseWriter, r *http.Request) {
...
func (a *Server) handleUpdateProject(w http.ResponseWriter, r *http.Request) {
...
func (a *Server) handlePinProject(w http.ResponseWriter, r *http.Request) {
...
func (a *Server) handleDeleteProject(w http.ResponseWriter, r *http.Request) {
...
func (a *Server) handleProjectPromptPreview(w http.ResponseWriter, r *http.Request) {
