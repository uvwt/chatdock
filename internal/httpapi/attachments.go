...
func (a *Server) handleUploadFile(w http.ResponseWriter, r *http.Request) {
...
func (a *Server) persistUploadedFile(id string, name string, contentType string, source io.Reader) (persistedUpload, error) {
...
func (a *Server) handleDownloadFile(w http.ResponseWriter, r *http.Request) {
...
func (a *Server) handleModelImageFile(w http.ResponseWriter, r *http.Request) {
	id := strings.TrimSpace(r.PathValue("id"))
...
func (a *Server) prepareVisionAttachmentURLs(history []model.Message) []model.Message {
...
func (a *Server) modelImageURL(id string, filename string, expiresAt time.Time) (string, error) {
...
func (a *Server) verifyModelImageSignature(id string, expiresRaw string, sig string, now time.Time) bool {
	id = strings.TrimSpace(id)
...
func (a *Server) signModelImage(id string, expires string) string {
...
func (a *Server) modelImageSigningSecret() []byte {
