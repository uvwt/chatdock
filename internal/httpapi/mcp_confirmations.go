...
func (a *Server) handleListMCPConfirmations(w http.ResponseWriter, r *http.Request) {
...
func (a *Server) handleResolveMCPConfirmation(w http.ResponseWriter, r *http.Request) {
