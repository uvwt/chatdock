...
func (a *Server) handleListModelProviders(w http.ResponseWriter, r *http.Request) {
...
func (a *Server) handleCreateModelProvider(w http.ResponseWriter, r *http.Request) {
...
func (a *Server) handleUpdateModelProvider(w http.ResponseWriter, r *http.Request) {
	var input store.ModelProviderInput
	if err := readJSON(r, &input); err != nil {
		writeError(w, http.StatusBadRequest, err)
		return
...
func (a *Server) handleDeleteModelProvider(w http.ResponseWriter, r *http.Request) {
...
func (a *Server) modelConfigFromRequest(r *http.Request) (model.ModelConfig, error) {
...
func (a *Server) handleTestModelProvider(w http.ResponseWriter, r *http.Request) {
...
func (a *Server) handleListProviderModels(w http.ResponseWriter, r *http.Request) {
	cfg, err := a.modelConfigFromRequest(r)
	if err != nil {
		writeError(w, http.StatusBadRequest, err)
		return
