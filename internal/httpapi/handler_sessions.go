...
func (a *Server) handleGetSession(w http.ResponseWriter, r *http.Request) {
...
func (a *Server) handlePinSession(w http.ResponseWriter, r *http.Request) {
...
func (a *Server) handleUpdateSessionModel(w http.ResponseWriter, r *http.Request) {
...
func (a *Server) handleRenameSession(w http.ResponseWriter, r *http.Request) {
...
func (a *Server) handleCloneSession(w http.ResponseWriter, r *http.Request) {
...
func (a *Server) handleBranchSession(w http.ResponseWriter, r *http.Request) {
...
func (a *Server) handleEditMessage(w http.ResponseWriter, r *http.Request) {
...
func (a *Server) handleExportSession(w http.ResponseWriter, r *http.Request) {
	session, ok, err := a.store.GetSession(r.PathValue("id"))
	if err != nil {
		writeError(w, http.StatusBadRequest, err)
		return
