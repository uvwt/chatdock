...
func (a *Server) handleGetMCPConfig(w http.ResponseWriter, r *http.Request) {
...
func (a *Server) handleSaveMCPConfig(w http.ResponseWriter, r *http.Request) {
...
func (a *Server) activeMCPConfig() (mcp.MCPConfig, error) {
...
func (a *Server) handleListMCPTools(w http.ResponseWriter, r *http.Request) {
...
func (a *Server) handleTestMCPServer(w http.ResponseWriter, r *http.Request) {
	cfg, err := a.activeMCPConfig()
	if err != nil {
		writeError(w, http.StatusBadRequest, err)
		return
...
func (a *Server) handleCallMCPTool(w http.ResponseWriter, r *http.Request) {
